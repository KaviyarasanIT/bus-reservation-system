...
public class Inserting_Data_In_Travels_Impl implements Adding_Data_To_Tables_Service {
    ...
    public Response sri_krishna_travels_travels(Adding_Data_To_Travels_Request adding_data_to_travels_request) {
        Sri_Krishna_Travels sri_krishna_travels=new Sri_Krishna_Travels();
        sri_krishna_travels.setBus_id(adding_data_to_travels_request.getBus_id());
        sri_krishna_travels.setTraveldate(adding_data_to_travels_request.getTraveldate());
        sri_krishna_travels.setBus_timing(adding_data_to_travels_request.getBus_timing());
        sri_krishna_travels.setSource(adding_data_to_travels_request.getSource());
        sri_krishna_travels.setDestination(adding_data_to_travels_request.getDestination());
        sri_krishna_travels.setDestination_stop(adding_data_to_travels_request.getDestination_stop());
        sri_krishna_travels.setAmenities(adding_data_to_travels_request.getAmenities());
        sri_krishna_travels.setSeat_available(adding_data_to_travels_request.getSeat_available());
        sri_krishna_travels.setBus_fare(adding_data_to_travels_request.getBus_fare());
        sri_krishna_travels.setStart_time(adding_data_to_travels_request.getStart_time());
        sri_krishna_travels.setEnd_time(adding_data_to_travels_request.getEnd_time());
        sri_krishna_travels.setHotel_booked_seat(adding_data_to_travels_request.getHotel_booked_seat());
        sri_krishna_travels_repository.save(sri_krishna_travels);
